...
Only activate when the current user message literally contains the word
"caffeinate". Do not infer or carry over from previous messages.

- When you start working (before making tool calls): `touch
/tmp/opencode-active`
- When work is finished (after all tool calls, before your final response): `rm
-f /tmp/opencode-active`
