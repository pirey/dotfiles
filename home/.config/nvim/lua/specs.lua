...
local fugitive = {
  ...
  config = function()
    ...
    local fugitive_prefix = "<c-g>"
    local fugitive_map = function(key)
      return fugitive_prefix .. key
    end
    ...
    local last_pos = { 1, 0 }
    vim.keymap.set("n", fugitive_map("s"), function()
    ...
    vim.keymap.set("n", fugitive_map("f"), "<cmd>tab Git log " .. log_format .. " -- %<cr>", { silent = true })
    vim.keymap.set("n", fugitive_map("l"), "<cmd>tab Git " .. log_str .. "<cr>", { silent = true })
    vim.keymap.set("n", fugitive_map("n"), function()
    ...
    end, { silent = true, desc = "paginate fugitive log" })
  end,
}
